  ...
  <body>
    ...
    <main class="main_home">
      ...
      <div class="container search_filters">
        <div class="filter">
          <a href="#" class="filter_dropdown_btn" id="continent">Continent <img src="icons/arrow-grey.png" id="dropdown_arrow_continent" alt="options"></a>
        ...
        <div class="filter">
          <a href="#" class="filter_dropdown_btn" id="category">Category <img src="icons/arrow-grey.png" id="dropdown_arrow_category" alt="options"></a>
        ...
        <div class="project_pages">
          <?php
            ...
            if($total >= 2 && $current_page != 1){
              $back = $current_page - 1;
              echo "<a class='number_page arrow back' href='?page=$back' data-page='$back'><img src=\"icons/arrow-white.png\" class=\"arrow-back\"></a>";
            }else{
                echo "<a class='number_page arrow back invisible' href='?page=#' data-page='#'><img src=\"icons/arrow-white.png\" class=\"arrow-back\"></a>";
            }
            ...
            if($total >= $current_page){
              $next = $current_page + 1;
              echo "<a class='number_page arrow next' href='?page=$next' data-page='$next'><img src=\"icons/arrow-white.png\" class=\"arrow-next\"></a>";
            }else{
                echo "<a class='number_page arrow next invisible' href='?page=#' data-page='#'><img src=\"icons/arrow-white.png\" class=\"arrow-next\"></a>";
            }
          ?>
        </div>
      </div>
